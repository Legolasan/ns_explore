...
public final class TbaUtils {
    ...
    public static String getBaseString(TokenPassport tokenPassport) {
        return TbaUtils.getBaseString(tokenPassport.getAccount(), tokenPassport.getConsumerKey(), tokenPassport.getToken(), tokenPassport.getNonce(), tokenPassport.getTimestamp());
    }
    ...
    public static String getKey(String consumerSecret, String tokenSecret) {
        return CommonUtils.concatenateStrings(DELIMITER, TbaUtils.percentEncode(consumerSecret), TbaUtils.percentEncode(tokenSecret));
    }
