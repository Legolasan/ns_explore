...
import com.netsuite.suitetalk.proxy.v2022_1.platform.core.types.SearchTextNumberFieldOperator;
...
implements Serializable {
    ...
    static {
        typeDesc.setXmlType(new QName("urn:core_2022_1.platform.webservices.netsuite.com", "SearchTextNumberField"));
        AttributeDesc attrField = new AttributeDesc();
        attrField.setFieldName("operator");
        attrField.setXmlName(new QName("", "operator"));
        attrField.setXmlType(new QName("urn:types.core_2022_1.platform.webservices.netsuite.com", "SearchTextNumberFieldOperator"));
