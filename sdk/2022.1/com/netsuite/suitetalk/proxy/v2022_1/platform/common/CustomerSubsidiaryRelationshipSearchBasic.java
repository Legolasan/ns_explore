...
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(CustomerSubsidiaryRelationshipSearchBasic.class, true);

    public CustomerSubsidiaryRelationshipSearchBasic() {
    }

    public CustomerSubsidiaryRelationshipSearchBasic(SearchDoubleField balance, SearchDoubleField depositBalance, SearchMultiSelectField entity, SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchBooleanField isPrimarySub, SearchMultiSelectField primaryCurrency, SearchMultiSelectField subsidiary, SearchDoubleField unbilledOrders, SearchCustomFieldList customFieldList) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof CustomerSubsidiaryRelationshipSearchBasic)) {
            return false;
        }
        ...
        boolean _equals = super.equals(obj) && (this.balance == null && other.getBalance() == null || this.balance != null && this.balance.equals(other.getBalance())) && (this.depositBalance == null && other.getDepositBalance() == null || this.depositBalance != null && this.depositBalance.equals(other.getDepositBalance())) && (this.entity == null && other.getEntity() == null || this.entity != null && this.entity.equals(other.getEntity())) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && this.externalId.equals(other.getExternalId())) && (this.externalIdString == null && other.getExternalIdString() == null || this.externalIdString != null && this.externalIdString.equals(other.getExternalIdString())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && this.internalId.equals(other.getInternalId())) && (this.internalIdNumber == null && other.getInternalIdNumber() == null || this.internalIdNumber != null && this.internalIdNumber.equals(other.getInternalIdNumber())) && (this.isPrimarySub == null && other.getIsPrimarySub() == null || this.isPrimarySub != null && this.isPrimarySub.equals(other.getIsPrimarySub())) && (this.primaryCurrency == null && other.getPrimaryCurrency() == null || this.primaryCurrency != null && this.primaryCurrency.equals(other.getPrimaryCurrency())) && (this.subsidiary == null && other.getSubsidiary() == null || this.subsidiary != null && this.subsidiary.equals(other.getSubsidiary())) && (this.unbilledOrders == null && other.getUnbilledOrders() == null || this.unbilledOrders != null && this.unbilledOrders.equals(other.getUnbilledOrders())) && (this.customFieldList == null && other.getCustomFieldList() == null || this.customFieldList != null && this.customFieldList.equals(other.getCustomFieldList()));
    ...
    static {
        typeDesc.setXmlType(new QName("urn:common_2022_1.platform.webservices.netsuite.com", "CustomerSubsidiaryRelationshipSearchBasic"));
