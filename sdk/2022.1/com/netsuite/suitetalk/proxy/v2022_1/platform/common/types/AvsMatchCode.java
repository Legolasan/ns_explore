...
implements Serializable {
    ...
    public static AvsMatchCode fromString(String value) throws IllegalArgumentException {
        return AvsMatchCode.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return AvsMatchCode.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.common_2022_1.platform.webservices.netsuite.com", "AvsMatchCode"));
    }
}
