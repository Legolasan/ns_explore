...
implements Serializable {
    ...
    public synchronized int hashCode() {
        ...
        return _hashCode += new Double(this.getValue()).hashCode();
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:core_2022_1.platform.webservices.netsuite.com", "DoubleCustomFieldRef"));
