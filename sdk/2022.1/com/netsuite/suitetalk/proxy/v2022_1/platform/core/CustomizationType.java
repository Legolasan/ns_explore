...
implements Serializable {
    ...
    static {
        typeDesc.setXmlType(new QName("urn:core_2022_1.platform.webservices.netsuite.com", "CustomizationType"));
        AttributeDesc attrField = new AttributeDesc();
        attrField.setFieldName("getCustomizationType");
        attrField.setXmlName(new QName("", "getCustomizationType"));
        attrField.setXmlType(new QName("urn:types.core_2022_1.platform.webservices.netsuite.com", "GetCustomizationType"));
