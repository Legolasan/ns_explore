...
implements Serializable {
    ...
    public SalesTaxItemSearchRowBasic(SearchColumnStringField[] description, SearchColumnSelectField[] externalId, SearchColumnSelectField[] internalId, SearchColumnBooleanField[] isInactive, SearchColumnStringField[] itemId, SearchColumnStringField[] name, SearchColumnSelectField[] taxType) {
    ...
    static {
        typeDesc.setXmlType(new QName("urn:common_2022_1.platform.webservices.netsuite.com", "SalesTaxItemSearchRowBasic"));
