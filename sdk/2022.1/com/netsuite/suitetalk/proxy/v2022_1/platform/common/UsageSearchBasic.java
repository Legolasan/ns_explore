...
implements Serializable {
    ...
    public UsageSearchBasic(SearchMultiSelectField customer, SearchDateField date, SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchMultiSelectField item, SearchStringField memo, SearchDoubleField quantity, SearchEnumMultiSelectField status, SearchMultiSelectField subscription, SearchMultiSelectField subscriptionLine, SearchMultiSelectField subscriptionPlan) {
    ...
    static {
        typeDesc.setXmlType(new QName("urn:common_2022_1.platform.webservices.netsuite.com", "UsageSearchBasic"));
        ...
        elemField.setXmlName(new QName("urn:common_2022_1.platform.webservices.netsuite.com", "subscriptionPlan"));
        elemField.setXmlType(new QName("urn:core_2022_1.platform.webservices.netsuite.com", "SearchMultiSelectField"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc((FieldDesc)elemField);
