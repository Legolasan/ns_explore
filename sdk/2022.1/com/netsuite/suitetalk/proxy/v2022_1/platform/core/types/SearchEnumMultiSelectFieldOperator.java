...
public class SearchEnumMultiSelectFieldOperator
implements Serializable {
    ...
    public static SearchEnumMultiSelectFieldOperator fromString(String value) throws IllegalArgumentException {
        return SearchEnumMultiSelectFieldOperator.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return SearchEnumMultiSelectFieldOperator.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.core_2022_1.platform.webservices.netsuite.com", "SearchEnumMultiSelectFieldOperator"));
    }
}
