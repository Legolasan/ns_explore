...
implements Serializable {
    ...
    private SearchMultiSelectField hierarchyLevel;
    private SearchMultiSelectField hierarchyVersion;
    private SearchMultiSelectField internalId;
    private SearchLongField internalIdNumber;
    private SearchStringField name;
    private SearchMultiSelectField parentNode;
    private Object __equalsCalc = null;
    private boolean __hashCodeCalc = false;
    private static TypeDesc typeDesc = new TypeDesc(MerchandiseHierarchyNodeSearchBasic.class, true);

    public MerchandiseHierarchyNodeSearchBasic() {
    }

    public MerchandiseHierarchyNodeSearchBasic(SearchStringField description, SearchMultiSelectField externalId, SearchStringField externalIdString, SearchMultiSelectField hierarchyLevel, SearchMultiSelectField hierarchyVersion, SearchMultiSelectField internalId, SearchLongField internalIdNumber, SearchStringField name, SearchMultiSelectField parentNode) {
    ...
    public void setHierarchyLevel(SearchMultiSelectField hierarchyLevel) {
        this.hierarchyLevel = hierarchyLevel;
    }
    ...
    public void setParentNode(SearchMultiSelectField parentNode) {
        this.parentNode = parentNode;
    }

    @Override
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof MerchandiseHierarchyNodeSearchBasic)) {
            return false;
        }
        ...
        boolean _equals = super.equals(obj) && (this.description == null && other.getDescription() == null || this.description != null && this.description.equals(other.getDescription())) && (this.externalId == null && other.getExternalId() == null || this.externalId != null && this.externalId.equals(other.getExternalId())) && (this.externalIdString == null && other.getExternalIdString() == null || this.externalIdString != null && this.externalIdString.equals(other.getExternalIdString())) && (this.hierarchyLevel == null && other.getHierarchyLevel() == null || this.hierarchyLevel != null && this.hierarchyLevel.equals(other.getHierarchyLevel())) && (this.hierarchyVersion == null && other.getHierarchyVersion() == null || this.hierarchyVersion != null && this.hierarchyVersion.equals(other.getHierarchyVersion())) && (this.internalId == null && other.getInternalId() == null || this.internalId != null && this.internalId.equals(other.getInternalId())) && (this.internalIdNumber == null && other.getInternalIdNumber() == null || this.internalIdNumber != null && this.internalIdNumber.equals(other.getInternalIdNumber())) && (this.name == null && other.getName() == null || this.name != null && this.name.equals(other.getName())) && (this.parentNode == null && other.getParentNode() == null || this.parentNode != null && this.parentNode.equals(other.getParentNode()));
    ...
    static {
        typeDesc.setXmlType(new QName("urn:common_2022_1.platform.webservices.netsuite.com", "MerchandiseHierarchyNodeSearchBasic"));
