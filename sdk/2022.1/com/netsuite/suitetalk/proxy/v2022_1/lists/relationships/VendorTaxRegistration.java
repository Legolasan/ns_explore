...
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(VendorTaxRegistration.class, true);

    public VendorTaxRegistration() {
    }

    public VendorTaxRegistration(Country nexusCountry, RecordRef nexus, RecordRef address, String taxRegistrationNumber, Long id) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof VendorTaxRegistration)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:relationships_2022_1.lists.webservices.netsuite.com", "VendorTaxRegistration"));
