...
implements Serializable {
    ...
    public static TaxAcctType fromString(String value) throws IllegalArgumentException {
        return TaxAcctType.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return TaxAcctType.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.accounting_2022_1.lists.webservices.netsuite.com", "TaxAcctType"));
    }
}
