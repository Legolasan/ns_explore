 ...
 */
package com.netsuite.suitetalk.proxy.v2022_1.lists.marketing.types;
...
public class CampaignCampaignDirectMailStatus
implements Serializable {
    ...
    public static CampaignCampaignDirectMailStatus fromString(String value) throws IllegalArgumentException {
        return CampaignCampaignDirectMailStatus.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return CampaignCampaignDirectMailStatus.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.marketing_2022_1.lists.webservices.netsuite.com", "CampaignCampaignDirectMailStatus"));
    }
}
