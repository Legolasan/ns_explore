...
implements Serializable {
    private MerchandiseHierarchyNodeSearchBasic basic;
    private MerchandiseHierarchyNodeSearchBasic parentNodeJoin;
    private Object __equalsCalc = null;
    private boolean __hashCodeCalc = false;
    private static TypeDesc typeDesc = new TypeDesc(MerchandiseHierarchyNodeSearch.class, true);

    public MerchandiseHierarchyNodeSearch() {
    }

    public MerchandiseHierarchyNodeSearch(MerchandiseHierarchyNodeSearchBasic basic, MerchandiseHierarchyNodeSearchBasic parentNodeJoin) {
        this.basic = basic;
    ...
    public void setBasic(MerchandiseHierarchyNodeSearchBasic basic) {
        this.basic = basic;
    }
    ...
    public void setParentNodeJoin(MerchandiseHierarchyNodeSearchBasic parentNodeJoin) {
        this.parentNodeJoin = parentNodeJoin;
    }

    @Override
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof MerchandiseHierarchyNodeSearch)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "MerchandiseHierarchyNodeSearch"));
