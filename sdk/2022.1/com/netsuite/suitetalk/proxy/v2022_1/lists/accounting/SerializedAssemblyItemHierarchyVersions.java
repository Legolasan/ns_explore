...
public class SerializedAssemblyItemHierarchyVersions
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(SerializedAssemblyItemHierarchyVersions.class, true);

    public SerializedAssemblyItemHierarchyVersions() {
    }

    public SerializedAssemblyItemHierarchyVersions(Boolean isIncluded, RecordRef hierarchyVersion, Calendar startDate, Calendar endDate, RecordRef hierarchyNode) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof SerializedAssemblyItemHierarchyVersions)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "SerializedAssemblyItemHierarchyVersions"));
