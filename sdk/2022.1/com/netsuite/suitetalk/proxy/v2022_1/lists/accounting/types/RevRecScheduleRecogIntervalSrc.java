...
public class RevRecScheduleRecogIntervalSrc
implements Serializable {
    ...
    public static RevRecScheduleRecogIntervalSrc fromString(String value) throws IllegalArgumentException {
        return RevRecScheduleRecogIntervalSrc.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return RevRecScheduleRecogIntervalSrc.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.accounting_2022_1.lists.webservices.netsuite.com", "RevRecScheduleRecogIntervalSrc"));
    }
}
