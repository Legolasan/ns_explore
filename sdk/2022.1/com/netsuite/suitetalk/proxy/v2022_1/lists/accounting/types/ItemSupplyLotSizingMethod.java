...
public class ItemSupplyLotSizingMethod
implements Serializable {
    ...
    public static ItemSupplyLotSizingMethod fromString(String value) throws IllegalArgumentException {
        return ItemSupplyLotSizingMethod.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return ItemSupplyLotSizingMethod.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.accounting_2022_1.lists.webservices.netsuite.com", "ItemSupplyLotSizingMethod"));
    }
}
