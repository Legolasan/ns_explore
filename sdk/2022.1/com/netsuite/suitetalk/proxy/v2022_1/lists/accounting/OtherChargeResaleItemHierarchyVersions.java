...
public class OtherChargeResaleItemHierarchyVersions
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(OtherChargeResaleItemHierarchyVersions.class, true);

    public OtherChargeResaleItemHierarchyVersions() {
    }

    public OtherChargeResaleItemHierarchyVersions(Boolean isIncluded, RecordRef hierarchyVersion, Calendar startDate, Calendar endDate, RecordRef hierarchyNode) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof OtherChargeResaleItemHierarchyVersions)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "OtherChargeResaleItemHierarchyVersions"));
