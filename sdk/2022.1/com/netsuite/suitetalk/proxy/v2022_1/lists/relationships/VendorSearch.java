...
implements Serializable {
    ...
    private LocationSearchBasic manufacturingLocationsJoin;
    ...
    public VendorSearch(VendorSearchBasic basic, AccountSearchBasic accountJoin, CampaignSearchBasic campaignResponseJoin, ContactSearchBasic contactJoin, ContactSearchBasic contactPrimaryJoin, AccountSearchBasic expAccountJoin, FileSearchBasic fileJoin, LocationSearchBasic manufacturingLocationsJoin, MessageSearchBasic messagesJoin, MessageSearchBasic messagesFromJoin, MessageSearchBasic messagesToJoin, MseSubsidiarySearchBasic mseSubsidiaryJoin, EntityTaxRegistrationSearchBasic taxRegistrationJoin, EmployeeSearchBasic timeApproverJoin, TransactionSearchBasic transactionJoin, EmployeeSearchBasic userJoin, NoteSearchBasic userNotesJoin, CustomSearchJoin[] customSearchJoin) {
        this.basic = basic;
    ...
    public void setManufacturingLocationsJoin(LocationSearchBasic manufacturingLocationsJoin) {
        this.manufacturingLocationsJoin = manufacturingLocationsJoin;
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:relationships_2022_1.lists.webservices.netsuite.com", "VendorSearch"));
