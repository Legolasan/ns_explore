...
public class ServiceResaleItemHierarchyVersions
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(ServiceResaleItemHierarchyVersions.class, true);

    public ServiceResaleItemHierarchyVersions() {
    }

    public ServiceResaleItemHierarchyVersions(Boolean isIncluded, RecordRef hierarchyVersion, Calendar startDate, Calendar endDate, RecordRef hierarchyNode) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof ServiceResaleItemHierarchyVersions)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "ServiceResaleItemHierarchyVersions"));
