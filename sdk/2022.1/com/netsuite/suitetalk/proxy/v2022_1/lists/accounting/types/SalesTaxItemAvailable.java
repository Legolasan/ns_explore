...
public class SalesTaxItemAvailable
implements Serializable {
    ...
    public static SalesTaxItemAvailable fromString(String value) throws IllegalArgumentException {
        return SalesTaxItemAvailable.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return SalesTaxItemAvailable.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.accounting_2022_1.lists.webservices.netsuite.com", "SalesTaxItemAvailable"));
    }
}
