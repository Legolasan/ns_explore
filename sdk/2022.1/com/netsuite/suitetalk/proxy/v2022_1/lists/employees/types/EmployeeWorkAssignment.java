...
implements Serializable {
    ...
    public static EmployeeWorkAssignment fromString(String value) throws IllegalArgumentException {
        return EmployeeWorkAssignment.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return EmployeeWorkAssignment.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.employees_2022_1.lists.webservices.netsuite.com", "EmployeeWorkAssignment"));
    }
}
