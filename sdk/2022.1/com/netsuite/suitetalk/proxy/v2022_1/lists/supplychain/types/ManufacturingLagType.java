...
public class ManufacturingLagType
implements Serializable {
    ...
    public static ManufacturingLagType fromString(String value) throws IllegalArgumentException {
        return ManufacturingLagType.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return ManufacturingLagType.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.supplychain_2022_1.lists.webservices.netsuite.com", "ManufacturingLagType"));
    }
}
