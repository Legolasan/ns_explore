...
public class LotNumberedInventoryItemHierarchyVersions
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(LotNumberedInventoryItemHierarchyVersions.class, true);

    public LotNumberedInventoryItemHierarchyVersions() {
    }

    public LotNumberedInventoryItemHierarchyVersions(Boolean isIncluded, RecordRef hierarchyVersion, Calendar startDate, Calendar endDate, RecordRef hierarchyNode) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof LotNumberedInventoryItemHierarchyVersions)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "LotNumberedInventoryItemHierarchyVersions"));
