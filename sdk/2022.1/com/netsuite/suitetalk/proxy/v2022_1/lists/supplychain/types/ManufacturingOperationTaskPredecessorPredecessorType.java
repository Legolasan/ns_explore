 ...
 */
package com.netsuite.suitetalk.proxy.v2022_1.lists.supplychain.types;
...
public class ManufacturingOperationTaskPredecessorPredecessorType
implements Serializable {
    ...
    public static ManufacturingOperationTaskPredecessorPredecessorType fromString(String value) throws IllegalArgumentException {
        return ManufacturingOperationTaskPredecessorPredecessorType.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return ManufacturingOperationTaskPredecessorPredecessorType.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.supplychain_2022_1.lists.webservices.netsuite.com", "ManufacturingOperationTaskPredecessorPredecessorType"));
    }
}
