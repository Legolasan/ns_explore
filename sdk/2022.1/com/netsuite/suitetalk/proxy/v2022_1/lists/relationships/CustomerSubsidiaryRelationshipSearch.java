...
import com.netsuite.suitetalk.proxy.v2022_1.platform.common.CustomerSubsidiaryRelationshipSearchBasic;
...
implements Serializable {
    private CustomerSubsidiaryRelationshipSearchBasic basic;
    ...
    private static TypeDesc typeDesc = new TypeDesc(CustomerSubsidiaryRelationshipSearch.class, true);

    public CustomerSubsidiaryRelationshipSearch() {
    }

    public CustomerSubsidiaryRelationshipSearch(CustomerSubsidiaryRelationshipSearchBasic basic, CustomerSearchBasic customerJoin, SubsidiarySearchBasic subsidiaryJoin, CustomSearchJoin[] customSearchJoin) {
        this.basic = basic;
    ...
    public void setBasic(CustomerSubsidiaryRelationshipSearchBasic basic) {
        this.basic = basic;
    }
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof CustomerSubsidiaryRelationshipSearch)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:relationships_2022_1.lists.webservices.netsuite.com", "CustomerSubsidiaryRelationshipSearch"));
        ElementDesc elemField = new ElementDesc();
        elemField.setFieldName("basic");
        elemField.setXmlName(new QName("urn:relationships_2022_1.lists.webservices.netsuite.com", "basic"));
        elemField.setXmlType(new QName("urn:common_2022_1.platform.webservices.netsuite.com", "CustomerSubsidiaryRelationshipSearchBasic"));
