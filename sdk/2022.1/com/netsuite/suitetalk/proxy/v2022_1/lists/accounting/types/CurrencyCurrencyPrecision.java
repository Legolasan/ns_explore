...
public class CurrencyCurrencyPrecision
implements Serializable {
    ...
    public static CurrencyCurrencyPrecision fromString(String value) throws IllegalArgumentException {
        return CurrencyCurrencyPrecision.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return CurrencyCurrencyPrecision.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.accounting_2022_1.lists.webservices.netsuite.com", "CurrencyCurrencyPrecision"));
    }
}
