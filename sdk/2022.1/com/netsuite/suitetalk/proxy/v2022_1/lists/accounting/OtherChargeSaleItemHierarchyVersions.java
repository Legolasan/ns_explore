...
public class OtherChargeSaleItemHierarchyVersions
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(OtherChargeSaleItemHierarchyVersions.class, true);

    public OtherChargeSaleItemHierarchyVersions() {
    }

    public OtherChargeSaleItemHierarchyVersions(Boolean isIncluded, RecordRef hierarchyVersion, Calendar startDate, Calendar endDate, RecordRef hierarchyNode) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof OtherChargeSaleItemHierarchyVersions)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "OtherChargeSaleItemHierarchyVersions"));
