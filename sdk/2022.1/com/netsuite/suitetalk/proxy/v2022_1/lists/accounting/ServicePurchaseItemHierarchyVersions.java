...
public class ServicePurchaseItemHierarchyVersions
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(ServicePurchaseItemHierarchyVersions.class, true);

    public ServicePurchaseItemHierarchyVersions() {
    }

    public ServicePurchaseItemHierarchyVersions(Boolean isIncluded, RecordRef hierarchyVersion, Calendar startDate, Calendar endDate, RecordRef hierarchyNode) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof ServicePurchaseItemHierarchyVersions)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "ServicePurchaseItemHierarchyVersions"));
