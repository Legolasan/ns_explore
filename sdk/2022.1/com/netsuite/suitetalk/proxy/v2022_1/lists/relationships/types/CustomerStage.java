...
implements Serializable {
    ...
    public static CustomerStage fromString(String value) throws IllegalArgumentException {
        return CustomerStage.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return CustomerStage.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.relationships_2022_1.lists.webservices.netsuite.com", "CustomerStage"));
    }
}
