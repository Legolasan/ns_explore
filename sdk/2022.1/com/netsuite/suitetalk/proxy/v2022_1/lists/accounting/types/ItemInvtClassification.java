...
public class ItemInvtClassification
implements Serializable {
    ...
    public static ItemInvtClassification fromString(String value) throws IllegalArgumentException {
        return ItemInvtClassification.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return ItemInvtClassification.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.accounting_2022_1.lists.webservices.netsuite.com", "ItemInvtClassification"));
    }
}
