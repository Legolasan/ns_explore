...
public class NonInventoryPurchaseItemHierarchyVersions
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(NonInventoryPurchaseItemHierarchyVersions.class, true);

    public NonInventoryPurchaseItemHierarchyVersions() {
    }

    public NonInventoryPurchaseItemHierarchyVersions(Boolean isIncluded, RecordRef hierarchyVersion, Calendar startDate, Calendar endDate, RecordRef hierarchyNode) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof NonInventoryPurchaseItemHierarchyVersions)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "NonInventoryPurchaseItemHierarchyVersions"));
