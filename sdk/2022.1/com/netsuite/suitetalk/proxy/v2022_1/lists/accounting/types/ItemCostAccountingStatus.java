...
public class ItemCostAccountingStatus
implements Serializable {
    ...
    public static ItemCostAccountingStatus fromString(String value) throws IllegalArgumentException {
        return ItemCostAccountingStatus.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return ItemCostAccountingStatus.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.accounting_2022_1.lists.webservices.netsuite.com", "ItemCostAccountingStatus"));
    }
}
