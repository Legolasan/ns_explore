...
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(CustomerTaxRegistration.class, true);

    public CustomerTaxRegistration() {
    }

    public CustomerTaxRegistration(Country nexusCountry, RecordRef nexus, RecordRef address, String taxRegistrationNumber, Long id) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof CustomerTaxRegistration)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:relationships_2022_1.lists.webservices.netsuite.com", "CustomerTaxRegistration"));
