...
implements Serializable {
    ...
    public static SupportCaseStage fromString(String value) throws IllegalArgumentException {
        return SupportCaseStage.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return SupportCaseStage.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.support_2022_1.lists.webservices.netsuite.com", "SupportCaseStage"));
    }
}
