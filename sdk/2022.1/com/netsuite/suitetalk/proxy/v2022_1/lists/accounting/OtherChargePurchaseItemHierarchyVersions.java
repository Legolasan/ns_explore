...
public class OtherChargePurchaseItemHierarchyVersions
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(OtherChargePurchaseItemHierarchyVersions.class, true);

    public OtherChargePurchaseItemHierarchyVersions() {
    }

    public OtherChargePurchaseItemHierarchyVersions(Boolean isIncluded, RecordRef hierarchyVersion, Calendar startDate, Calendar endDate, RecordRef hierarchyNode) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof OtherChargePurchaseItemHierarchyVersions)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "OtherChargePurchaseItemHierarchyVersions"));
