...
implements Serializable {
    ...
    public static SolutionStatus fromString(String value) throws IllegalArgumentException {
        return SolutionStatus.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return SolutionStatus.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.support_2022_1.lists.webservices.netsuite.com", "SolutionStatus"));
    }
}
