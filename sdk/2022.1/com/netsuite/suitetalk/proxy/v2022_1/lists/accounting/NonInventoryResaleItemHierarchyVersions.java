...
public class NonInventoryResaleItemHierarchyVersions
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(NonInventoryResaleItemHierarchyVersions.class, true);

    public NonInventoryResaleItemHierarchyVersions() {
    }

    public NonInventoryResaleItemHierarchyVersions(Boolean isIncluded, RecordRef hierarchyVersion, Calendar startDate, Calendar endDate, RecordRef hierarchyNode) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof NonInventoryResaleItemHierarchyVersions)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "NonInventoryResaleItemHierarchyVersions"));
