...
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(ItemGroupHierarchyVersions.class, true);

    public ItemGroupHierarchyVersions() {
    }

    public ItemGroupHierarchyVersions(Boolean isIncluded, RecordRef hierarchyVersion, Calendar startDate, Calendar endDate, RecordRef hierarchyNode) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof ItemGroupHierarchyVersions)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "ItemGroupHierarchyVersions"));
