...
public class AccountingBookStatus
implements Serializable {
    ...
    public static AccountingBookStatus fromString(String value) throws IllegalArgumentException {
        return AccountingBookStatus.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return AccountingBookStatus.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.accounting_2022_1.lists.webservices.netsuite.com", "AccountingBookStatus"));
    }
}
