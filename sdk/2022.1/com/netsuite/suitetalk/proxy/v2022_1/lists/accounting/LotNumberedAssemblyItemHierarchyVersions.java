...
public class LotNumberedAssemblyItemHierarchyVersions
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(LotNumberedAssemblyItemHierarchyVersions.class, true);

    public LotNumberedAssemblyItemHierarchyVersions() {
    }

    public LotNumberedAssemblyItemHierarchyVersions(Boolean isIncluded, RecordRef hierarchyVersion, Calendar startDate, Calendar endDate, RecordRef hierarchyNode) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof LotNumberedAssemblyItemHierarchyVersions)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "LotNumberedAssemblyItemHierarchyVersions"));
