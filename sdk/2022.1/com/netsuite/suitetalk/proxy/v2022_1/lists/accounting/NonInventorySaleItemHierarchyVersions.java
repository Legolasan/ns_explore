...
public class NonInventorySaleItemHierarchyVersions
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(NonInventorySaleItemHierarchyVersions.class, true);

    public NonInventorySaleItemHierarchyVersions() {
    }

    public NonInventorySaleItemHierarchyVersions(Boolean isIncluded, RecordRef hierarchyVersion, Calendar startDate, Calendar endDate, RecordRef hierarchyNode) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof NonInventorySaleItemHierarchyVersions)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:accounting_2022_1.lists.webservices.netsuite.com", "NonInventorySaleItemHierarchyVersions"));
