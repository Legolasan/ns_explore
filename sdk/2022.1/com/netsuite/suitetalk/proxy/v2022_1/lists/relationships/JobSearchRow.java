...
implements Serializable {
    ...
    private EmployeeSearchRowBasic projectManagerJoin;
    ...
    public JobSearchRow(JobSearchRowBasic basic, BillingAccountSearchRowBasic billingAccountJoin, BillingScheduleSearchRowBasic billingScheduleJoin, ContactSearchRowBasic contactPrimaryJoin, CustomerSearchRowBasic customerJoin, EmployeeSearchRowBasic projectManagerJoin, ProjectTaskSearchRowBasic projectTaskJoin, ResourceAllocationSearchRowBasic resourceAllocationJoin, TaskSearchRowBasic taskJoin, TimeBillSearchRowBasic timeJoin, CustomSearchRowBasic[] customSearchJoin) {
        this.basic = basic;
    ...
    public void setProjectManagerJoin(EmployeeSearchRowBasic projectManagerJoin) {
        this.projectManagerJoin = projectManagerJoin;
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:relationships_2022_1.lists.webservices.netsuite.com", "JobSearchRow"));
