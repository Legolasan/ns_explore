...
public class ResourceAllocationAllocationUnit
implements Serializable {
    ...
    public static ResourceAllocationAllocationUnit fromString(String value) throws IllegalArgumentException {
        return ResourceAllocationAllocationUnit.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return ResourceAllocationAllocationUnit.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.scheduling_2022_1.activities.webservices.netsuite.com", "ResourceAllocationAllocationUnit"));
    }
}
