...
implements Serializable {
    ...
    public static CalendarEventStatus fromString(String value) throws IllegalArgumentException {
        return CalendarEventStatus.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return CalendarEventStatus.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.scheduling_2022_1.activities.webservices.netsuite.com", "CalendarEventStatus"));
    }
}
