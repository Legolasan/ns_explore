...
public class CalendarEventAttendeeAttendance
implements Serializable {
    ...
    public static CalendarEventAttendeeAttendance fromString(String value) throws IllegalArgumentException {
        return CalendarEventAttendeeAttendance.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return CalendarEventAttendeeAttendance.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.scheduling_2022_1.activities.webservices.netsuite.com", "CalendarEventAttendeeAttendance"));
    }
}
