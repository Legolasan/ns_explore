...
public class CalendarEventAccessLevel
implements Serializable {
    ...
    public static CalendarEventAccessLevel fromString(String value) throws IllegalArgumentException {
        return CalendarEventAccessLevel.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return CalendarEventAccessLevel.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.scheduling_2022_1.activities.webservices.netsuite.com", "CalendarEventAccessLevel"));
    }
}
