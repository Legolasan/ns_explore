...
implements Serializable {
    ...
    public static TaskReminderType fromString(String value) throws IllegalArgumentException {
        return TaskReminderType.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return TaskReminderType.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.scheduling_2022_1.activities.webservices.netsuite.com", "TaskReminderType"));
    }
}
