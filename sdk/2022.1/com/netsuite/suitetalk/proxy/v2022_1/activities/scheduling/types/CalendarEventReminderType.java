...
public class CalendarEventReminderType
implements Serializable {
    ...
    public static CalendarEventReminderType fromString(String value) throws IllegalArgumentException {
        return CalendarEventReminderType.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return CalendarEventReminderType.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.scheduling_2022_1.activities.webservices.netsuite.com", "CalendarEventReminderType"));
    }
}
