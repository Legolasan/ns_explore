...
public class ProjectTaskPredecessorPredecessorType
implements Serializable {
    ...
    public static ProjectTaskPredecessorPredecessorType fromString(String value) throws IllegalArgumentException {
        return ProjectTaskPredecessorPredecessorType.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return ProjectTaskPredecessorPredecessorType.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.scheduling_2022_1.activities.webservices.netsuite.com", "ProjectTaskPredecessorPredecessorType"));
    }
}
