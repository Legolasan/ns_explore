...
implements Serializable {
    ...
    public static ProjectTaskStatus fromString(String value) throws IllegalArgumentException {
        return ProjectTaskStatus.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return ProjectTaskStatus.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.scheduling_2022_1.activities.webservices.netsuite.com", "ProjectTaskStatus"));
    }
}
