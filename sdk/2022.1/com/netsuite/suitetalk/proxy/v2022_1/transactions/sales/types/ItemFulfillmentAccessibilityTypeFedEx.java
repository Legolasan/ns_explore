...
public class ItemFulfillmentAccessibilityTypeFedEx
implements Serializable {
    ...
    public static ItemFulfillmentAccessibilityTypeFedEx fromString(String value) throws IllegalArgumentException {
        return ItemFulfillmentAccessibilityTypeFedEx.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return ItemFulfillmentAccessibilityTypeFedEx.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.sales_2022_1.transactions.webservices.netsuite.com", "ItemFulfillmentAccessibilityTypeFedEx"));
    }
}
