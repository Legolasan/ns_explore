...
public class InboundShipmentShipmentStatus
implements Serializable {
    ...
    public static InboundShipmentShipmentStatus fromString(String value) throws IllegalArgumentException {
        return InboundShipmentShipmentStatus.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return InboundShipmentShipmentStatus.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.purchases_2022_1.transactions.webservices.netsuite.com", "InboundShipmentShipmentStatus"));
    }
}
