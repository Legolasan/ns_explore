...
public class ItemFulfillmentThirdPartyTypeUps
implements Serializable {
    ...
    public static ItemFulfillmentThirdPartyTypeUps fromString(String value) throws IllegalArgumentException {
        return ItemFulfillmentThirdPartyTypeUps.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return ItemFulfillmentThirdPartyTypeUps.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.sales_2022_1.transactions.webservices.netsuite.com", "ItemFulfillmentThirdPartyTypeUps"));
    }
}
