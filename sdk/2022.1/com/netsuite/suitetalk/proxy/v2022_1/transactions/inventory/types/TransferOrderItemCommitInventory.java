...
public class TransferOrderItemCommitInventory
implements Serializable {
    ...
    public static TransferOrderItemCommitInventory fromString(String value) throws IllegalArgumentException {
        return TransferOrderItemCommitInventory.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return TransferOrderItemCommitInventory.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.inventory_2022_1.transactions.webservices.netsuite.com", "TransferOrderItemCommitInventory"));
    }
}
