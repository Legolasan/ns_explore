...
public class CustomSaleSalesTeam
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(CustomSaleSalesTeam.class, true);

    public CustomSaleSalesTeam() {
    }

    public CustomSaleSalesTeam(RecordRef employee, RecordRef salesRole, Boolean isPrimary, Double contribution) {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof CustomSaleSalesTeam)) {
            return false;
        }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:customization_2022_1.setup.webservices.netsuite.com", "CustomSaleSalesTeam"));
        ElementDesc elemField = new ElementDesc();
        elemField.setFieldName("employee");
        elemField.setXmlName(new QName("urn:customization_2022_1.setup.webservices.netsuite.com", "employee"));
        ...
        elemField.setXmlName(new QName("urn:customization_2022_1.setup.webservices.netsuite.com", "salesRole"));
        elemField.setXmlType(new QName("urn:core_2022_1.platform.webservices.netsuite.com", "RecordRef"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc((FieldDesc)elemField);
        ...
        elemField.setXmlName(new QName("urn:customization_2022_1.setup.webservices.netsuite.com", "isPrimary"));
        ...
        elemField.setXmlName(new QName("urn:customization_2022_1.setup.webservices.netsuite.com", "contribution"));
