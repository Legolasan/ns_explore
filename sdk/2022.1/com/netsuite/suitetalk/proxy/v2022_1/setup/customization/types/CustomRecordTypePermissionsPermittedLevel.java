...
public class CustomRecordTypePermissionsPermittedLevel
implements Serializable {
    ...
    public static CustomRecordTypePermissionsPermittedLevel fromString(String value) throws IllegalArgumentException {
        return CustomRecordTypePermissionsPermittedLevel.fromValue(value);
    }
    ...
    public Object readResolve() throws ObjectStreamException {
        return CustomRecordTypePermissionsPermittedLevel.fromValue(this._value_);
    }
    ...
    static {
        typeDesc.setXmlType(new QName("urn:types.customization_2022_1.setup.webservices.netsuite.com", "CustomRecordTypePermissionsPermittedLevel"));
    }
}
